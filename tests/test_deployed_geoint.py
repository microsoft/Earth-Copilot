...
# Your backend URL - update with your deployed URL or set BACKEND_API_URL environment variable
BASE_URL = os.getenv("BACKEND_API_URL", "https://your-container-app.azurecontainerapps.io")
