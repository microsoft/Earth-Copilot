...
export interface PlanetaryExplorerMapResponse {
  dataset_ids?: string[];
  summary: string;
  date_range?: {
    start_date: string;
...
export class PlanetaryExplorerMapIntegration {
   ...
   */
  processResponse(response: any): PlanetaryExplorerMapResponse {
    ...
    if (response.dataset_ids && response.bbox && response.action) {
      return response as PlanetaryExplorerMapResponse;
    }
   ...
   */
  private extractDataFromResponse(response: any): PlanetaryExplorerMapResponse | null {
    try {
      ...
      const result: PlanetaryExplorerMapResponse = {
   ...
   */
  visualizeOnMap(data: PlanetaryExplorerMapResponse): void {
  ...
  private loadDataOnMap(data: PlanetaryExplorerMapResponse): void {
  ...
  private loadTilesOnMap(data: PlanetaryExplorerMapResponse): void {
  ...
  private setupCompareMode(data: PlanetaryExplorerMapResponse): void {
    console.log('Planetary Explorer: Setting up compare mode with date range:', data.date_range);
    this.loadDataOnMap(data);
  }

  private setupAnalysisMode(data: PlanetaryExplorerMapResponse): void {
    console.log('Planetary Explorer: Setting up analysis mode');
    this.loadDataOnMap(data);
  }

  private showAnimation(data: PlanetaryExplorerMapResponse): void {
 ...
 */
export function enhanceMessageForMapVisualization(message: string, response: any): PlanetaryExplorerMapResponse {
