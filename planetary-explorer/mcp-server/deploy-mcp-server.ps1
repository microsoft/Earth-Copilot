# Planetary-Explorer MCP Server Deployment Script
#
# This script deploys the Planetary-Explorer Model Context Protocol server with:
...
Write-Host " Deploying Planetary-Explorer MCP Server" -ForegroundColor Cyan
...
try {
    ...
    if (-not $WhatIf) {
        ...
        $appSettings = @(
            ...
            "PLANETARY_EXPLORER_BASE_URL=https://your-planetary-explorer.azurewebsites.net",
    ...
    if ($DeployApim) {
        ...
        if (-not $WhatIf) {
            ...
            $publisherName = "Planetary-Explorer Team"
...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    return func.HttpResponse(
        "Planetary-Explorer MCP Server is running. Use /docs for API documentation.",
        status_code=200,
...
"@
    ...
    # Display results
    Write-Host ""
    Write-Host " Planetary-Explorer MCP Server Deployment Complete!" -ForegroundColor Green
    ...
    if ($DeployApim) {
        ...
        Write-Host " MCP API: $apimUrl/planetary-explorer/mcp" -ForegroundColor White
    }
    ...
    Write-Host "3.  Integrate with Planetary-Explorer main application" -ForegroundColor White
    ...
    $configFile = "planetary-explorer-mcp-deployment.json"
...
Write-Host ""
Write-Host " Planetary-Explorer MCP Server is ready!" -ForegroundColor Green