...
resource keyVault 'Microsoft.KeyVault/vaults@2023-07-01' = {
  ...
  properties: {
    ...
    // Soft delete is enabled by default (Azure enforced). Purge protection is
    // intentionally OMITTED (not set to true) so that soft-deleted vaults can be
    // purged, allowing redeployment after an RG deletion without name conflicts.
