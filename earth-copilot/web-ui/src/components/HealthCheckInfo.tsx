        ...
        <div className="health-tooltip-content">
          <div className="health-section">
            ...
            <div className="health-status-item">
              ...
              <span className={`health-value ${healthData.connectivity_tests.azure_openai?.status === 'connected' && healthData.basic_checks.azure_openai_endpoint && (healthData.basic_checks.azure_openai_api_key || healthData.basic_checks.use_managed_identity) && healthData.basic_checks.azure_openai_deployment ? 'success' : 'error'}`}>
                {healthData.connectivity_tests.azure_openai?.status === 'connected' && healthData.basic_checks.azure_openai_endpoint && (healthData.basic_checks.azure_openai_api_key || healthData.basic_checks.use_managed_identity) && healthData.basic_checks.azure_openai_deployment ? '✅ Connected' : '❌ Disconnected'}
              </span>
            </div>
