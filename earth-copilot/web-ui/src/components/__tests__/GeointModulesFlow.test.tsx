  ...
  describe('Chat Integration Flow', () => {
    it('should display all GEOINT notifications in Chat component', async () => {
      ...
      const mobilityAnalysisResults = [
        ...
        { type: 'info', message: '📍 **Pin Mode Activated** - Click on the map to drop your pin.' },
        { type: 'pin_dropped', message: '📍 **Coordinates stored.**', coordinates: { lat: 40.7128, lng: -74.0060 } },
        { type: 'pending', message: '💭 **Thinking...**\n\nPerforming Terrain Analysis using GPT-5 Vision on satellite imagery.' },
        { 
          type: 'complete', 
          data: { 
            result: { 
