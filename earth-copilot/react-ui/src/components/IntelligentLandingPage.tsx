...
const IntelligentLandingPage: React.FC<IntelligentLandingPageProps> = ({ onRouteResult }) => {
  ...
  const routingMutation = useMutation({
    ...
    onError: (error) => {
      ...
      // Fallback: redirect to general geocopilot
      setTimeout(() => {
      ...
      <div style={{
        ...
        {routingMutation.isPending && (
          <div style={{ textAlign: 'center', padding: '3rem' }}>
            ...
            <p style={{ color: '#666' }}>
              Using MCP and AutoGen to find the best data source for you
            </p>
          </div>
        )}
        ...
        {routingResult && (
          <div style={{ textAlign: 'center', padding: '2rem' }}>
            ...
            <p style={{ color: '#666', marginBottom: '1rem' }}>
              Redirecting you to the specialized GeoCopilot interface...
            </p>
            <div style={{ 
