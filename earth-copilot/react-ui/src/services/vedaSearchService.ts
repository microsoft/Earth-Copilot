...
class VEDASearchService {
  ...
  constructor() {
    ...
    console.log('🔧 VEDA Service Config:', {
      hasSearchEndpoint: !!this.config.searchEndpoint && this.config.searchEndpoint.includes('search.windows.net'),
      hasSearchApiKey: !!this.config.searchApiKey && this.config.searchApiKey.length > 10,
      hasOpenAIEndpoint: !!this.config.openaiEndpoint && this.config.openaiEndpoint.includes('openai.azure.com'),
      hasOpenAIApiKey: !!this.config.openaiApiKey && this.config.openaiApiKey.length > 10,
      searchIndex: this.config.searchIndex,
      openaiDeployment: this.config.openaiDeployment
    });
  }
