...
class EarthCopilotMCPServer:
    ...
    def __init__(self):
        ...
        self.base_url = os.getenv('EARTH_COPILOT_BASE_URL', 'http://localhost:8000')
        self.backend_api_url = os.getenv('EARTH_COPILOT_API_URL', 'http://localhost:8000')
        self.geoint_url = os.getenv('GEOINT_SERVICE_URL', 'http://localhost:8000')
