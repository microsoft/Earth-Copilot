...
class EarthCopilotMCPServer:
    ...
    def __init__(self):
        ...
        # Configuration - update with your deployed URLs or set environment variables
        self.base_url = os.getenv('EARTH_COPILOT_BASE_URL', 'https://your-web-ui.azurewebsites.net')
        self.backend_api_url = os.getenv('EARTH_COPILOT_API_URL', 'https://your-container-app.azurecontainerapps.io')
