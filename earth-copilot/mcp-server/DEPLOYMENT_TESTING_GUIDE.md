...
- Deployed MCP Server URL (e.g., `https://your-mcp-server.azurecontainerapps.io`)
...
```powershell
# PowerShell
$MCP_URL = "https://your-mcp-server.azurecontainerapps.io"
Invoke-WebRequest -Uri "$MCP_URL/" -Method GET | Select-Object -ExpandProperty Content
```

```bash
# Bash/Linux
curl https://your-mcp-server.azurecontainerapps.io/
```
...
```bash
# Bash/Linux
curl -X POST https://your-mcp-server.azurecontainerapps.io/tools/list
```
...
```bash
# Bash/Linux
curl -X POST https://your-mcp-server.azurecontainerapps.io/resources/read \
...
```bash
# Bash/Linux
curl -X POST https://your-mcp-server.azurecontainerapps.io/tools/call \
  -H "Content-Type: application/json" \
  -d '{
    "name": "terrain_analysis",
    "arguments": {
...
Example: python test_deployed_mcp.py https://your-mcp-server.azurecontainerapps.io
"""
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python test_deployed_mcp.py https://your-mcp-server.azurecontainerapps.io")
        sys.exit(1)
