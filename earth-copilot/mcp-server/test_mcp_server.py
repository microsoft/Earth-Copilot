...
def test_tools_list():
    ...
    try:
        ...
        data = response.json()
        print(f"✅ Success! Found {len(data.get('tools', []))} tools:")
        print()
...
def test_resources_list():
    ...
    try:
        ...
        data = response.json()
        print(f"✅ Success! Found {len(data.get('resources', []))} resources:")
        print()
...
def test_terrain_analysis():
    ...
    try:
        ...
        data = response.json()
        print(f"✅ Success! Terrain analysis result:")
        print()
...
if __name__ == "__main__":
    print("\n🌍 Earth Copilot MCP Server - HTTP Bridge Tests\n")
