# Bootstrap GitHub Environment for Planetary Explorer Deployment (PowerShell)
#
...
#
# Example:
#   .\scripts\bootstrap-github-environment.ps1 -ConfigFile .github\environment-config-dev.yml -Repo "microsoft/Planetary-Explorer"
#
...
function Set-EnvironmentSecrets {
    ...
    Write-Host "    --name 'sp-planetaryexplorer-$ENV_NAME' ``" -ForegroundColor Gray
...
function Main {
    ...
    Write-Host "  Planetary Explorer GitHub Environment Bootstrap" -ForegroundColor Cyan
    Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "[SUCCESS] Your Planetary Explorer will be live in ~10-15 minutes!" -ForegroundColor Green
}
