...
function Main {
    ...
    Write-Host "  ✓ Deploy infrastructure to Azure" -ForegroundColor White
    Write-Host "  ✓ Build and deploy backend container" -ForegroundColor White
    Write-Host "  ✓ Build and deploy frontend app" -ForegroundColor White
    Write-Host "  ✓ Store all secrets in Key Vault" -ForegroundColor White
    Write-Host ""
