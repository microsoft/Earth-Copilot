#!/usr/bin/env bash
#
# Bootstrap GitHub Environment for Planetary Explorer Deployment
#
...
#
# Example:
#   ./scripts/bootstrap-github-environment.sh .github/environment-config-dev.yml microsoft/Planetary-Explorer
#
...
set_secrets() {
    ...
    echo "    --name 'sp-planetaryexplorer-$ENV_NAME' \\"
...
main() {
    if [ $# -lt 1 ]; then
        ...
        log_info "Example: $0 .github/environment-config-dev.yml microsoft/Planetary-Explorer"
        exit 1
    fi
    ...
    log_info "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    log_info "  Planetary Explorer GitHub Environment Bootstrap"
    log_info "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    ...
    echo ""
    log_success "Your Planetary Explorer will be live in ~10-15 minutes!"
}
