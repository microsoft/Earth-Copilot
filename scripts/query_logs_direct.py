...
print("=" * 100)
print("🔍 QUERYING AZURE LOG ANALYTICS FOR CALIFORNIA WILDFIRE QUERY")
print("=" * 100)
...
try:
    ...
    if not logs:
        print("⚠️  No matching logs found in the last 2 hours")
        print()
    ...
    print("=" * 100)
    print(f"✅ Query complete - {len(logs)} entries displayed")
    print("=" * 100)
